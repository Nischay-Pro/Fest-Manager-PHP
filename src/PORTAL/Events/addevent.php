...
<html>
<head>
<title>Upgrade Event Round</title>
...
<nav>
 <ul class="navigbar">
 <li><a href="index.php">Back to Controlz Dashboard</a></li>
...
<form class="form-horizontal" action="addevent.php" role="form" method="POST">
        ...
        <input class="btn btn-lg btn-success"  type="submit" value="Add New Round" name="register" >
      </div>
      </form>
      </div>
